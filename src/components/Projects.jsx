...
const ProjectCard = ({ title, description }) => {
    return (
        <div className="project-card shadow-lg rounded-lg p-8 m-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/3 md:text-center">
...
const Projects = () => {
    ...
    return (
        <section id="projects" className="projects-container py-20 px-6 md:px-20 lg:px-40 min-h-screen">
