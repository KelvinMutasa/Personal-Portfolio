...
const ProjectCard = ({ title, description }) => {
    return (
        <div className="project-card bg-white shadow-lg rounded-lg p-8 m-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/3 md:text-center">
            ...
            <p className="text-gray-700 mb-6 md:text-2xl">{description}</p>
            <div className="buttons flex space-x-4 md:flex-col md:space-y-4 md:space-x-0 md:items-center md:text-2xl">
