...
const ProjectCard = ({ title, description }) => {
    return (
        <div className="project-card bg-white shadow-lg rounded-lg p-8 m-6 w-full md:w-1/2 lg:w-1/3">
...
const Projects = () => {
    ...
    return (
        <section id="projects" className="projects-container py-20 bg-bgColor min-h-screen">
